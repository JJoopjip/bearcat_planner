export type MochiPose =
  | "angry" | "awestruck" | "bored" | "cheeky" | "confident" | "confused"
  | "curious" | "determined" | "disappointed" | "drink" | "excited"
  | "exercising" | "giggling" | "happy" | "hungry" | "icecream" | "love"
  | "mischievous" | "peeking" | "playful" | "playing" | "proud" | "reading"
  | "sad" | "scared" | "shy" | "sleeping" | "surprised" | "thinking"
  | "thumbsup" | "tired" | "waving";

// backdrop tint per pose, from the spec's tint table (new poses added
// 2026-08-17 for the habit sticker picker use a matching pastel, not the
// spec's literal table since it predates them)
...
/**
 * Rolls a day's individual mood check-ins (1-5, sad..excited) into one
 ...
 * them. E.g. four "happy"(50) + one "disappointed"(25) checks = 45%. Returns
